 ...
 * Write Characteristic Descriptor request and return a `SAL_LE_RAS_CCCD_NOT_IMPR_CONFIG_ERR`
 ...
 * `SAL_LE_RAS_CCCD_WR_REQ_REJECT` (0xFC).
 *
 ...
 * |---------------------------------------|------------|---------------------------------------------------------------------------------|
 * | **SAL_LE_RAS_RANGING_MODE_REAL_TIME** | 0x01       | Real-time ranging mode. Measurements are performed continuously or periodically in real time. |
 * | **SAL_LE_RAS_RANGING_MODE_ON_DEMAND** | 0x02       | On-demand ranging mode. Measurements are performed only when explicitly requested by the client. |
 * | **SAL_LE_RAS_RANGING_MODE_UNDEFINED** | 0xFF       | Undefined or invalid mode. Used as default or error value.                       |
 *
 ...
 */
#define SAL_LE_RAS_STEP_DATA_BUF_LEN 2048
